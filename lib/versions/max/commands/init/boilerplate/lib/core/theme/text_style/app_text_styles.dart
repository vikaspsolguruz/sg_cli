...
class AppTextStyles {
  ...
  static TextStyle h1ExtraBold = const TextStyle(
    fontSize: 40,
    fontFamily: 'Inter',
  ...
  static TextStyle h2ExtraBold = const TextStyle(
    fontSize: 36,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 800)],
    height: 44 / 36,
  ...
  static TextStyle h3ExtraBold = const TextStyle(
    fontSize: 32,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 800)],
    height: 40 / 32,
  ...
  static TextStyle h4ExtraBold = const TextStyle(
    fontSize: 28,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 800)],
    height: 36 / 28,
  ...
  static TextStyle h5ExtraBold = const TextStyle(
    fontSize: 24,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 800)],
    height: 32 / 24,
  ...
  static TextStyle h6ExtraBold = const TextStyle(
    fontSize: 20,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 800)],
    height: 28 / 20,
  ...
  static TextStyle p1Regular = const TextStyle(
    fontSize: 18,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 400)],
    height: 28 / 18,
  ...
  static TextStyle p1ExtraBold = const TextStyle(
    fontSize: 18,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 800)],
    height: 28 / 18,
  ...
  static TextStyle p2SemiBoldUnderline = const TextStyle(
    fontSize: 16,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 600)],
    height: 1.5,
  ...
  static TextStyle p2ExtraBold = const TextStyle(
    fontSize: 16,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 800)],
    height: 1.5,
  ...
  static TextStyle p3ExtraBold = const TextStyle(
    fontSize: 14,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 800)],
    height: 20 / 14,
  ...
  static TextStyle p4ExtraBold = const TextStyle(
    fontSize: 12,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 800)],
    height: 20 / 12,
  ...
  static TextStyle c1Regular = const TextStyle(
    fontSize: 10,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 400)],
    height: 14 / 10,
  );
  static TextStyle c1Medium = const TextStyle(
    fontSize: 10,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 500)],
    height: 14 / 10,
  ...
  static TextStyle c1Bold = const TextStyle(
    fontSize: 10,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 700)],
    height: 14 / 10,
  );
  static TextStyle c1ExtraBold = const TextStyle(
    fontSize: 10,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 800)],
    height: 14 / 10,
  ...
  static TextStyle c2Bold = const TextStyle(
    fontSize: 8,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 700)],
    height: 14 / 8,
  );
  static TextStyle c2ExtraBold = const TextStyle(
    fontSize: 8,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 800)],
    height: 14 / 8,
  ...
  // Italic variants for emphasis (using fontStyle for italics)
  static TextStyle h1RegularItalic = const TextStyle(
    fontSize: 40,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 400), FontVariation('ital', 1)],
    fontStyle: FontStyle.italic,
    height: 48 / 40,
    letterSpacing: -0.4,
  );
  static TextStyle p2BoldItalic = const TextStyle(
    fontSize: 16,
    fontFamily: 'Inter',
    fontVariations: [FontVariation('wght', 700), FontVariation('ital', 1)],
    fontStyle: FontStyle.italic,
    height: 1.5,
  );
}
