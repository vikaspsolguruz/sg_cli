...
import 'package:newarch/core/data/password_validations.dart';
          ...
          return Row(
            children: [
              Icon(
                ...
                size: 16,
                color: e.isValid(text) ? AppColors.bgSuccessHover : AppColors.bgNeutralLight200,
              ),
              const SizedBox(width: 4),
              Text(
                e.errorMessage,
                style: AppTextStyles.p4Medium.copyWith(
                  color: e.isValid(text) ? AppColors.textSuccessSecondary : AppColors.textNeutralSecondary,
                ),
                maxLines: 2,
